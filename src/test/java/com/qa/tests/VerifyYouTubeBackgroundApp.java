...
public class VerifyYouTubeBackgroundApp extends BaseClass {

	@Test
	public void backgroundTest() throws MalformedURLException, Throwable {

		capabilities.setCapability("appPackage", (configProperties.getProperty("appPackageYouTube")));
		capabilities.setCapability("appActivity", (configProperties.getProperty("appActivityYouTube")));
		...
		ApplicationState Appstate = driver.queryAppState(configProperties.getProperty("appPackageYouTube"));
		...
		ApplicationState Appstate1 = driver.queryAppState(configProperties.getProperty("appPackageYouTube"));
		...
		boolean isAppRunningInBackground = driver.getPageSource().contains(configProperties.getProperty("appPackageYouTube"));
		...
		if (Appstate1.equals(configProperties.getProperty("appPackageYouTube"))) {
