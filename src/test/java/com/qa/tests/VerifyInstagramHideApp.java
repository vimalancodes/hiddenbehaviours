...
public class VerifyInstagramHideApp extends BaseClass {

	@Test
	public void hideTest() throws MalformedURLException, Throwable {
		capabilities.setCapability("appPackage", (configProperties.getProperty("appPackageInstagram")));
		capabilities.setCapability("appActivity", (configProperties.getProperty("appActivityInstagram")));
