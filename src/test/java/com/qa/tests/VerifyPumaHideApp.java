...
public class VerifyPumaHideApp extends BaseClass {

	@Test
	public void hideTest() throws MalformedURLException, Throwable {
		capabilities.setCapability("appPackage", (configProperties.getProperty("appPackagePuma")));
		capabilities.setCapability("appActivity", (configProperties.getProperty("appActivityPuma")));
