...
public class VerifyOfferupHideApp extends BaseClass {

	@Test
	public void hideTest() throws MalformedURLException, Throwable {
		capabilities.setCapability("appPackage", (configProperties.getProperty("appPackageOfferup")));
		capabilities.setCapability("appActivity", (configProperties.getProperty("appActivityOfferup")));
