...
public class VerifyAmazonPrimeBackgroundApp extends BaseClass {

	@Test
	public void backgroundTest() throws MalformedURLException, Throwable {

		capabilities.setCapability("appPackage", (configProperties.getProperty("appPackageAmazonPrime")));
		capabilities.setCapability("appActivity", (configProperties.getProperty("appActivityAmazonPrime")));
		...
		ApplicationState Appstate = driver.queryAppState(configProperties.getProperty("appPackageAmazonPrime"));
		...
		ApplicationState Appstate1 = driver.queryAppState(configProperties.getProperty("appPackageAmazonPrime"));
		...
		boolean isAppRunningInBackground = driver.getPageSource().contains(configProperties.getProperty("appPackageAmazonPrime"));
		...
		if (Appstate1.equals(configProperties.getProperty("appPackageAmazonPrime"))) {
