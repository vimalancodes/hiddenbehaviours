...
public class VerifyBinanceBackgroundApp extends BaseClass {

	@Test
	public void backgroundTest() throws MalformedURLException, Throwable {

		capabilities.setCapability("appPackage", (configProperties.getProperty("appPackageBinance")));
		capabilities.setCapability("appActivity", (configProperties.getProperty("appActivityBinance")));
		...
		ApplicationState Appstate = driver.queryAppState(configProperties.getProperty("appPackageBinance"));
		...
		ApplicationState Appstate1 = driver.queryAppState(configProperties.getProperty("appPackageBinance"));
		...
		boolean isAppRunningInBackground = driver.getPageSource().contains(configProperties.getProperty("appPackageBinance"));
		...
		if (Appstate1.equals(configProperties.getProperty("appPackageBinance"))) {
