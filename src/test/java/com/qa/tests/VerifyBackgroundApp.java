...
public class VerifyBackgroundApp extends BaseClass {

	@Test
	public void backgroundTest() throws MalformedURLException, Throwable {

		capabilities.setCapability("appPackage", (configProperties.getProperty("appPackage")));
		capabilities.setCapability("appActivity", (configProperties.getProperty("appActivity")));
		...
		ApplicationState Appstate = driver.queryAppState(configProperties.getProperty("appPackage"));
		...
		ApplicationState Appstate1 = driver.queryAppState(configProperties.getProperty("appPackage"));
		...
		boolean isAppRunningInBackground = driver.getPageSource().contains(configProperties.getProperty("appPackage"));
		...
		if (Appstate1.equals(configProperties.getProperty("appPackage"))) {
